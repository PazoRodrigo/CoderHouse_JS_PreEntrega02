...
const arrayEveryTrue = arraySome.some((elemento) => elemento > 0);
console.log("arrayEveryTrue > 0", arraySomeTrue);
const arrayEveryFalse = arraySome.some((elemento) => elemento > 1);
console.log("arraySomeFalse > 1", arraySomeFalse);
/*
...
console.log("arrayLastIndexOf Lorena", arrayLastIndexOf.lastIndexOf("Lorena"));
/*
 ...
 */
console.log("------ from()");
const cadena= 'El objeto Array de JavaScript es un objeto global que es usado en la construcción de arrays, que son objetos tipo lista de alto nivel.';
